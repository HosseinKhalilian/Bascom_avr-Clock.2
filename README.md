...
This clock uses a 6 digit 7-segments for display and has the ability to set the clock with using 3 keys. 
...
<p align="center">
<a href="./LICENSE.md">
<img alt="GitHub license" src="https://img.shields.io/github/license/khalilian-ah/Bascom_avr-Clock.2?style=badge">
</a>
